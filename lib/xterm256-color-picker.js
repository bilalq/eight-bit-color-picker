...
(function (root, factory) {
  ...
  XTerm256ColorPicker.prototype.buildColorMapUI = function() {
    ...
    colorMapEl.addEventListener('mouseover', function(e) {
      ...
      if (twentyFourBitColor == null) { return false }
    ...
    colorMapEl.addEventListener('mouseleave', (function(e) {
      selectedColorEl.style.background = this.getHexColor()
      eightBitTextEl.textContent = this.get8BitColor()
      hexTextEl.textContent = this.getHexColor()
    }).bind(this))
